...
- light-theme rebuild batches,
- compliance or policy sections that benefit from brighter clarity,
- analytical pages that should feel premium without inheriting the full dark-stage atmosphere,
- divider and proof pages where warmth and readability should lead.

Characteristics:

- warm light stage,
- dark graphite typography,
- orange-led primary emphasis,
- restrained blue support accent,
- elevated white-card surfaces,
- lighter and more editorial contrast behavior than the dark modes.
